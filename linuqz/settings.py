"""
Django settings for linuqz project.
...
SECRET_KEY = 'django-insecure-9x&$^h(offdtnu3&m!yq12k*lnv^9#opgp+tm86y!^-q1&_vkb'
...
WSGI_APPLICATION = 'linuqz.wsgi.application'
