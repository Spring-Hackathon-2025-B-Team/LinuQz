...
行番号をつけて表示するためのオプションは？','-z','-s','-n','-n','-n','「cat -n ファイル名」で、行番号をつけてファイルの中身を表示','2025-05-20 22:00:00','2025-05-20 22:00:00');
...
INSERT INTO questions (id,rank_id,question,choice_1,choice_2,choice_3,choice_4,answer,explanation,created_at,updated_at) VALUES ('cc66960261784dbd81169c3ff9e1e044',1,'システムのカーネル名（≒OS名）を表示するコマンドは？','uname','name','oname','osname','uname','LinuxはOSの一種であり、カーネルの名前でもある。
...
INSERT INTO questions (id,rank_id,question,choice_1,choice_2,choice_3,choice_4,answer,explanation,created_at,updated_at) VALUES ('cc66960261784dbd81169c3ff9e1e047',1,'プロセスの状態を確認するコマンドは？','pscheck','p','psc','ps','ps','オプションを付けずに実行すると
...
INSERT INTO questions (id,rank_id,question,choice_1,choice_2,choice_3,choice_4,answer,explanation,created_at,updated_at) VALUES ('cc66960261784dbd81169c3ff9e1e049',1,'プロセスを終了させるためのコマンドは？','end','kill','over','stop','kill','「kill プロセス名」で、指定したプロセスを終了','2025-05-20 22:00:00','2025-05-20 22:00:00');
...
INSERT INTO questions (id,rank_id,question,choice_1,choice_2,choice_3,choice_4,answer,explanation,created_at,updated_at) VALUES ('cc66960261784dbd81169c3ff9e1e052',1,'指定したファイルの中身を1画面ずつ表示するコマンドは？','less','ness','gess','hess','less','ページ分割して内容を表示（スクロール可）','2025-05-20 22:00:00','2025-05-20 22:00:00');
...
カーソル位置から行の最後までを削除するコマンドは？','Ctrl + a','Ctrl + e','Ctrl + u','Ctrl + k','Ctrl + k','「Ctrl + u」でカーソル位置から行の最後までを削除','2025-05-20 22:00:00','2025-05-20 22:00:00');
...
処理をキャンセルするコマンドは？','Ctrl + c','Ctrl + d','Ctrl + s','Ctrl + l','Ctrl + c','「Ctrl + c」で継続中の処理をキャンセル','2025-05-20 22:00:00','2025-05-20 22:00:00');
